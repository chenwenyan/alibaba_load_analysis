...
def graph():
    ...
    try:
        ...
        # ax5.hist(mss_avg_cpi, normed=False, alpha=1.0, bins=100)
        # ax6.hist(msm_avg_cpi, normed=False, alpha=1.0, bins=100)
        # ax7.hist(mms_avg_cpi, normed=False, alpha=1.0, bins=100)
        # ax8.hist(mmm_avg_cpi, normed=False, alpha=1.0, bins=100)
        ...
        # ax5.hist(mss_avg_mpki, normed=False, alpha=1.0, bins=100)
        # ax6.hist(msm_avg_mpki, normed=False, alpha=1.0)
        # ax7.hist(mms_avg_mpki, normed=False, alpha=1.0, bins=100)
        # ax8.hist(mmm_avg_mpki, normed=False, alpha=1.0, bins=100)
        #
        # ax1.set_title('sss')
        # ax2.set_title('ssm')
        # ax3.set_title('sms')
        ...
        # ax6.set_xlabel("average mpki for container instance category")
