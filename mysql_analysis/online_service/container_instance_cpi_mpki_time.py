...
def graph():
    ...
    # ax1.set_xlabel('cpi ts less 4(hour)')
    # ax2.set_xlabel('cpi ts more 4(hour) less 8(hour)')
    # ax3.set_xlabel('cpi ts more 8(hour) less 12(hour)')
    ...
    ax1.set_xlabel('mpki ts less 4(hour)')
    ax2.set_xlabel('mpki ts more 4(hour) less 8(hour)')
    ax3.set_xlabel('mpki ts more 8(hour) less 12(hour)')
    ax1.set_ylabel('portion of instance')
